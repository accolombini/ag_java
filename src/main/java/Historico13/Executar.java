...
public class Executar {
   ...
   public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost/produtos " +
                        "? useTimezone = true & serverTimezone = UTC", "angelo", "1234");
...
*/
        ...
        listaProdutos.add(new Produto("Notebook Dell", 0.0350, 2499.90));
        ...
        listaProdutos.add(new Produto("Microondas Panasonic", 0.319, 299.29));
        listaProdutos.add(new Produto("Geladeira Brastemp", 0.635, 849.90));
        ...
        Grafico g = new Grafico("Algoritmo genético", "Evolução das soluções",
                ag.getMelhoresCromossomos());
        g.pack();
